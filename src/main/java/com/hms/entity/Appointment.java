...
public class Appointment {
    ...
    // New constructor for UpdateAppointmentServlet
    public Appointment(int id, String fullName, String gender, int age, String appointmentDate, String email,
            String phone, String diseases, int doctorId, String address) {
        super();
        this.id = id;
        this.fullName = fullName;
        this.gender = gender;
        this.age = String.valueOf(age); // Assuming age is stored as String
        this.appointmentDate = appointmentDate;
        this.email = email;
        this.phone = phone;
        this.diseases = diseases;
