...
<nav class="navbar navbar-expand-lg navbar-dark"style="background-color: #52BE80;">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i class="fa-sharp fa-solid fa-hospital"></i> Healthcare Appointment Scheduling</a>
